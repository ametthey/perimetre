...
<div class="menu__about">
    ...
    <h2 data-fx="14">perimetre is a multidisciplinary creative studio. We conceive and produce content working in many fields including
            <a class="reveal-about" href="" data-img="<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg">art direction</a>,
            <a class="reveal-about" href="" data-img="<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg">strategy</a>,
            <a class="reveal-about" href="" data-img="<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg">graphic design</a>
            <a class="reveal-about" href="" data-img="<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg">motion design</a>
            <a class="reveal-about" href="" data-img="<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg">web development</a>
            <a class="reveal-about" href="" data-img="<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg,<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/about/futur.jpg">3D</a>. Beyond that, our diverse collaborations always pushes us to experiment ne practices and techniques. That’s what truly drives us. </h2>
